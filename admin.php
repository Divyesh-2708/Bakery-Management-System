...
?></div>
  ...
  <div class="feedback container w3-black" >
  <?php
    ...
    <h1><center>FEEDBACKS FROM USER</center></h1>
      <tbody>
          <?php
              ...
              {
                  echo "<tr>
                  <th class='col-2 w3-gray'><h4>E-MAIL :</h4></th><td class='col-3'><h4><span class='w3-margin-left w3-margin'>".$row['m_from']."</span></h4></td><th class='col-2 w3-gray'><h4>MESSAGE :</h4></th><td><h5><span class='w3-margin-left w3-margin'></span>".$row['msg']."</h5></td>
                  </tr>";
              }
              ?>
      </tbody>
